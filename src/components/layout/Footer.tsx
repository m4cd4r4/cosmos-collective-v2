...
import { Github, Twitter, ExternalLink, Heart, Accessibility } from 'lucide-react'
...
const footerLinks = {
  ...
  community: [
    ...
    { label: 'Forums', href: 'https://www.zooniverse.org/talk', external: true },
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
            <div className="flex items-center gap-1">
              <span>© {currentYear} Cosmos Collective. Made with</span>
