...
`;function ou(){return new fa({vertexShader:iu,fragmentShader:au,depthTest:!1,depthWrite:!1,transparent:!0,uniforms:{uResolution:{value:new K(1,1)},uArcsecPerPx:{value:.01},uThetaE:{value:1.61},uThetaSun:{value:1.48},uOcculterRsun:{value:1.04},uBetaS:{value:new K(0,0)},uSrcRadius:{value:.05},uJ2:{value:0},uPoleAngle:{value:Math.PI/2},uExposure:{value:1},uTime:{value:0},uSrcTex:{value:null},uCorona:{value:null},uHasCorona:{value:0},uCoronaHalfWidthRsun:{value:6.35},uLascoInnerRsun:{value:2.25}}})}var su=.05;function cu(e){let t=document.createElement(`div`);t.className=`ctl-row`;let n=document.createElement(`span`);n.className=`ctl-label`,n.textContent=e;let r=document.createElement(`span`);return r.className=`ctl-value`,t.append(n,r),{wrap:t,value:r}}function lu(e,t,n,r,i,a,o,s){let{wrap:c,value:l}=cu(t),u=document.createElement(`input`);u.type=`range`,u.min=String(n),u.max=String(r),u.step=String(i),u.value=String(a),l.textContent=o(a),u.addEventListener(`input`,()=>{let e=Number(u.value);l.textContent=o(e),s(e)}),c.appendChild(u),e.appendChild(c)}function uu(e,t,n,r,i){let a=document.createElement(`div`);a.className=`ctl-row`;let o=document.createElement(`button`);if(o.className=`ctl-toggle`,o.setAttribute(`aria-pressed`,String(r)),o.textContent=t,r&&o.classList.add(`on`),o.addEventListener(`click`,()=>{let e=!o.classList.contains(`on`);o.classList.toggle(`on`,e),o.setAttribute(`aria-pressed`,String(e)),i(e)}),a.appendChild(o),n){let e=document.createElement(`span`);e.className=`ctl-note`,e.textContent=n,a.appendChild(e)}e.appendChild(a)}var du=class{onChange;state={zAU:650,offsetArcsec:0,j2On:!1,exposure:1,fovArcsec:8,guidesOn:!0};readoutValues=new Map;status;constructor(e,t){this.onChange=t;let n=document.createElement(`div`);n.className=`spike-panel`;let r=document.createElement(`div`);r.className=`panel-title`,r.textContent=`LENS PARAMETERS`,n.appendChild(r);let i=this.state,a=(e,t)=>{i[e]=t,this.onChange()};lu(n,`HELIOCENTRIC DISTANCE`,548,1200,1,i.zAU,e=>`${e.toFixed(0)} AU`,e=>a(`zAU`,e)),lu(n,`SOURCE OFF-AXIS OFFSET`,0,2,.005,i.offsetArcsec,e=>`${e.toFixed(3)} arcsec`,e=>a(`offsetArcsec`,e)),lu(n,`EXPOSURE`,.2,4,.05,i.exposure,e=>`${e.toFixed(2)}x`,e=>a(`exposure`,e)),lu(n,`FIELD OF VIEW`,4,24,.5,i.fovArcsec,e=>`${e.toFixed(1)} arcsec`,e=>a(`fovArcsec`,e));let o=su/zl;uu(n,`J2 QUADRUPOLE`,`exaggerated ${Math.round(o/1e3)}k x for visibility, true J2 ${zl}`,i.j2On,e=>a(`j2On`,e)),uu(n,`ANGULAR GUIDES`,``,i.guidesOn,e=>a(`guidesOn`,e));let s=document.createElement(`div`);s.className=`panel-title`,s.textContent=`COMPUTED LIVE`,n.appendChild(s);for(let[e,t]of[[`thetaE`,`EINSTEIN RING theta_E`],[`thetaSun`,`SOLAR LIMB`],[`impact`,`RING IMPACT PARAMETER`],[`occulter`,`CORONAGRAPH OCCULTER`]]){let{wrap:r,value:i}=cu(t);this.readoutValues.set(e,i),n.appendChild(r)}this.status=document.createElement(`div`),this.status.className=`spike-status`,n.appendChild(this.status),e.appendChild(n)}updateReadouts(e){this.readoutValues.get(`thetaE`).textContent=`${e.thetaEArcsec.toFixed(3)} arcsec`,this.readoutValues.get(`thetaSun`).textContent=`${e.thetaSunArcsec.toFixed(3)} arcsec`,this.readoutValues.get(`impact`).textContent=`${e.ringImpactRsun.toFixed(3)} R_sun`,this.readoutValues.get(`occulter`).textContent=`${e.occulterRsun.toFixed(2)} R_sun`,this.status.textContent=e.ringVisible?`Ring clear of the occulter`:`Ring behind the occulter: move outward along the focal line`,this.status.classList.toggle(`warn`,!e.ringVisible)}},fu={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},pu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},mu=new Ga(-1,1,1,-1,0,1),hu=new class extends Cr{constructor(){super(),this.setAttribute(`position`,new Z([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Z([0,2,0,0,2,0],2))}},gu=class{constructor(e){this._mesh=new di(hu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,mu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},_u=class extends pu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof fa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=la.clone(e.uniforms),this.material=new fa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new gu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},vu=class extends pu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},yu=class extends pu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},bu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new Wt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new _u(fu),this.copyPass.material.blending=0,this.timer=new Xa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}vu!==void 0&&(r instanceof vu?n=!0:r instanceof yu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},xu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Tu.BlurDirectionX=new K(1,0),Tu.BlurDirectionY=new K(0,1);function Eu(e,t,n,r=.85){let i=new bu(e);i.addPass(new Cu(t,n));let a=new Tu(new K(1920,1080),r,.55,.55);return i.addPass(a),i.addPass(new Su),{composer:i,resize:(e,t)=>{i.setSize(e,t),a.setSize(e,t)},setBloomStrength:e=>{a.strength=e}}}export{fa as $,fo as A,di as B,Al as C,Gi as D,Cr as E,Ci as F,vi as G,$i as H,Ii as I,Tt as J,ea as K,Fi as L,Z as M,Sn as N,X as O,ji as P,An as Q,e as R,Ll as S,lr as T,Ga as U,$r as V,Wa as W,ta as X,Qr as Y,Le as Z,Ml as _,nu as a,Ia as at,Nl as b,Yl as c,q as ct,Jl as d,na as et,Bl as f,Fl as g,Ul as h,ou as i,t as it,Xi as j,Zi as k,Xl as l,Vl as m,su as n,Ur as nt,ru as o,ra as ot,Hl as p,Hi as q,du as r,kr as rt,Kl as s,K as st,Eu as t,uo as tt,ql as u,Il as v,Yi as w,Pl as x,jl as y,wt as z};