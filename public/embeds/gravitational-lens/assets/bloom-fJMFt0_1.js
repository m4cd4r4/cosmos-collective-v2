...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(e,t,n){let r=new Float32Array(Es),i=new G(0,1,0);return new Ra({name:`SphericalGaussianBlur`,defines:{n:Es,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(){return new Ra({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new Ra({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Us(),fragmentShader:`
	...
	`}var Ws=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ha(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function id(){return new Ra({vertexShader:nd,fragmentShader:rd,depthTest:!1,depthWrite:!1,transparent:!0,uniforms:{uResolution:{value:new W(1,1)},uArcsecPerPx:{value:.01},uThetaE:{value:1.61},uThetaSun:{value:1.48},uOcculterRsun:{value:1.04},uBetaS:{value:new W(0,0)},uSrcRadius:{value:.05},uJ2:{value:0},uPoleAngle:{value:Math.PI/2},uExposure:{value:1},uTime:{value:0},uSrcTex:{value:null},uCorona:{value:null},uHasCorona:{value:0},uCoronaHalfWidthRsun:{value:6.35},uLascoInnerRsun:{value:2.25}}})}var ad=.05;function od(e){let t=document.createElement(`div`);t.className=`ctl-row`;let n=document.createElement(`span`);n.className=`ctl-label`,n.textContent=e;let r=document.createElement(`span`);return r.className=`ctl-value`,t.append(n,r),{wrap:t,value:r}}function sd(e,t,n,r,i,a,o,s){let{wrap:c,value:l}=od(t),u=document.createElement(`input`);u.type=`range`,u.min=String(n),u.max=String(r),u.step=String(i),u.value=String(a),l.textContent=o(a),u.addEventListener(`input`,()=>{let e=Number(u.value);l.textContent=o(e),s(e)}),c.appendChild(u),e.appendChild(c)}function cd(e,t,n,r,i){let a=document.createElement(`div`);a.className=`ctl-row`;let o=document.createElement(`button`);if(o.className=`ctl-toggle`,o.setAttribute(`aria-pressed`,String(r)),o.textContent=t,r&&o.classList.add(`on`),o.addEventListener(`click`,()=>{let e=!o.classList.contains(`on`);o.classList.toggle(`on`,e),o.setAttribute(`aria-pressed`,String(e)),i(e)}),a.appendChild(o),n){let e=document.createElement(`span`);e.className=`ctl-note`,e.textContent=n,a.appendChild(e)}e.appendChild(a)}var ld=class{onChange;state={zAU:650,offsetArcsec:0,j2On:!1,exposure:1,fovArcsec:8,guidesOn:!0};readoutValues=new Map;status;constructor(e,t){this.onChange=t;let n=document.createElement(`div`);n.className=`spike-panel`;let r=document.createElement(`div`);r.className=`panel-title`,r.textContent=`LENS PARAMETERS`,n.appendChild(r);let i=this.state,a=(e,t)=>{i[e]=t,this.onChange()};sd(n,`HELIOCENTRIC DISTANCE`,548,1200,1,i.zAU,e=>`${e.toFixed(0)} AU`,e=>a(`zAU`,e)),sd(n,`SOURCE OFF-AXIS OFFSET`,0,2,.005,i.offsetArcsec,e=>`${e.toFixed(3)} arcsec`,e=>a(`offsetArcsec`,e)),sd(n,`EXPOSURE`,.2,4,.05,i.exposure,e=>`${e.toFixed(2)}x`,e=>a(`exposure`,e)),sd(n,`FIELD OF VIEW`,4,24,.5,i.fovArcsec,e=>`${e.toFixed(1)} arcsec`,e=>a(`fovArcsec`,e));let o=ad/Lu;cd(n,`J2 QUADRUPOLE`,`exaggerated ${Math.round(o/1e3)}k x for visibility, true J2 ${Lu}`,i.j2On,e=>a(`j2On`,e)),cd(n,`ANGULAR GUIDES`,``,i.guidesOn,e=>a(`guidesOn`,e));let s=document.createElement(`div`);s.className=`panel-title`,s.textContent=`COMPUTED LIVE`,n.appendChild(s);for(let[e,t]of[[`thetaE`,`EINSTEIN RING theta_E`],[`thetaSun`,`SOLAR LIMB`],[`impact`,`RING IMPACT PARAMETER`],[`occulter`,`CORONAGRAPH OCCULTER`]]){let{wrap:r,value:i}=od(t);this.readoutValues.set(e,i),n.appendChild(r)}this.status=document.createElement(`div`),this.status.className=`spike-status`,n.appendChild(this.status),e.appendChild(n)}updateReadouts(e){this.readoutValues.get(`thetaE`).textContent=`${e.thetaEArcsec.toFixed(3)} arcsec`,this.readoutValues.get(`thetaSun`).textContent=`${e.thetaSunArcsec.toFixed(3)} arcsec`,this.readoutValues.get(`impact`).textContent=`${e.ringImpactRsun.toFixed(3)} R_sun`,this.readoutValues.get(`occulter`).textContent=`${e.occulterRsun.toFixed(2)} R_sun`,this.status.textContent=e.ringVisible?`Ring clear of the occulter`:`Ring behind the occulter: move outward along the focal line`,this.status.classList.toggle(`warn`,!e.ringVisible)}},ud={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Cd.BlurDirectionX=new W(1,0),Cd.BlurDirectionY=new W(0,1);function wd(e,t,n,r=.85){let i=new vd(e);i.addPass(new xd(t,n));let a=new Cd(new W(1920,1080),r,.55,.55);return i.addPass(a),i.addPass(new bd),{composer:i,resize:(e,t)=>{i.setSize(e,t),a.setSize(e,t)},setBloomStrength:e=>{a.strength=e}}}export{sa as $,ga as A,kt as At,Z as B,_r as Bt,Ou as C,Po as Ct,ba as D,pa as Dt,qn as E,Ro as Et,Ca as F,Be as Ft,zi as G,jr as Gt,So as H,ls as Ht,us as I,Mn as It,Ja as J,bo as Jt,Er as K,t as Kt,Sa as L,Ra as Lt,i as M,ei as Mt,X as N,r as Nt,dr as O,ca as Ot,q as P,Da as Pt,Ji as Q,oo as Qt,Vo as R,Ai as Rt,Fu as S,zo as St,Ei as T,Ea as Tt,Wo as U,Io as Ut,wn as V,Oa as Vt,ji as W,Gr as Wt,Fe as X,W as Xt,I as Y,ka as Yt,na as Z,G as Zt,Au as _,c as _t,ed as a,mo as at,ju as b,Cn as bt,qu as c,Ar as ct,Ku as d,pi as dt,oa as et,Ru as f,ti as ft,Nu as g,o as gt,Vu as h,a as ht,id as i,Ve as it,xa as j,io as jt,Tr as k,cs as kt,Ju as l,Ot as lt,zu as m,Ba as mt,ad as n,d as nt,td as o,Ho as ot,Bu as p,Va as pt,Or as q,Gt as qt,ld as r,u as rt,Wu as s,e as st,wd as t,l as tt,Gu as u,Y as ut,Pu as v,s as vt,so as w,Ui as wt,Mu as x,Ta as xt,ku as y,no as yt,_o as z,Ti as zt};